---
title: "GPU setup (detailed)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{GPU setup (detailed)}
---
...
1. Compile and install OpenBLAS and its module (*optional*)
2. Compile and install R with optimized BLAS support and its module (*optional*)
3. Install `devil` from GitHub within R
