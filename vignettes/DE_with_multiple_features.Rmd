...
In this vignette we illustrate how to use **devil** with a **non-trivial design matrix** including multiple covariates and interactions, using the `RichardTCellData()` dataset from the **scRNAseq** package. We'll show how to:
...
- **Main effects**: `stimulus` (different T cell stimulation conditions), `age` (as continuous variable)
